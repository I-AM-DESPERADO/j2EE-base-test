...
{ 
	...
	public void goodUpdate(HttpServletRequest req,HttpServletResponse res){
		...
		String sql="update t_goods set mingcheng=?,jieshao=?,pinpa=?,dizhi=?,dianhua=?,youxiang=?,fujian=?,shichangjia=? where catelog_id=?";
		
		Object[] params={catelog_id,mingcheng,jieshao,pinpai,dizhi,dianhua,youxiang,fujian,shichangjia};
		DB mydb=new DB();
		mydb.doPstm(sql, params);
		mydb.closed();
