									...
									<TD align="center">
									    <form action="<%=path %>/buy?type=addToCart" method="post" name="buy">
			                                  <table width="100%" border="0" cellpadding="9" cellspacing="9">
												    ...
												    <tr>
												       <td align="left">厂家名称：${requestScope.goods.pinpai }</td>
												    </tr>
												     <tr>
												       <td align="left">厂家地址：${requestScope.goods.dizhi }</td>
												    </tr>
												     <tr>
												       <td align="left">厂家电话：${requestScope.goods.dianhua }</td>
												    </tr>
												     <tr>
												       <td align="left">厂家邮箱：${requestScope.goods.youxiang }</td>
												    </tr>
												    <tr>
